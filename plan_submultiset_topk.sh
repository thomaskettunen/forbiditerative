...
export PYTHONPATH=$PWD && $SOURCE/forbiditerative/plan.py --planner submultisets_topk --domain $1 --problem $2 --number-of-plans $3 $QBOUND --use-local-folder --clean-local-folder #--suppress-planners-output
