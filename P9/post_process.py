...
def get_relation(relation_string):
	...
	elif relation_string == "prefix_group_operator_dominance":
		return relations.prefix_group_op_dom
	elif relation_string == "truck_group_operator_dominance":
		return relations.truck_group_op_dom
...
if __name__ == "__main__":
	...
	parser.add_argument("relation", help="Choice of predefined relations", choices=["reorder", "operator_dominance", "prefix_group_operator_dominance", "truck_group_operator_dominance"])
